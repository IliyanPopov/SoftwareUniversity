<h1>OOP Basics Exam &ndash; Minedraft</h1>
<p>The solution is refactored with the best practices from the OOP Basics course.</p>
<p>Command design pattern is implemented</p>
...
<td>
<p>Successfully registered Sonic Harvester - AS-51</p>
