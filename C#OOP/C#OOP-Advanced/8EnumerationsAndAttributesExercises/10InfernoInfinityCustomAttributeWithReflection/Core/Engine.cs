        ...
        while (data[0] != "END")
        {
            ...
            switch (commandType)
            {
                ...
                case "Add":
                    ...
                    var weaponResultAddGem =
                        this._infernoInMemoryRepository.Weapons.FirstOrDefault(w => w.Name == weaponNameToAddGemTo);
                    var gemResult =
                        this._infernoInMemoryRepository.Gems.FirstOrDefault(
                            g => g.Type == gemType && g.ClarityType == gemClarityType);
