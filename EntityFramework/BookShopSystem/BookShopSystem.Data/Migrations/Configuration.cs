namespace BookShopSystem.Data.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<BookShopSystem.Data.BookShopContext>
    {
        ...
        {
            string[] authors = File.ReadAllLines("../../../BookShopSystem.Data/Import/authors.csv");
        ...
        private static void SeedBooks(BookShopContext context)
        {
            ...
            string[] books = File.ReadAllLines("../../../BookShopSystem.Data/Import/books.csv");
        ...
        private static void SeedCategories(BookShopContext context)
        {
            ...
            string[] categories = File.ReadAllLines("../../../BookShopSystem.Data/Import/categories.csv");
            ...
            for (int i = 1; i < categories.Length; i++)
            {
                ...
                Category category = new Category() { Name = categoryName, Books = new List<Book>() };
